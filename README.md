...
- Inheritance yang digunakan adalah **Hierarchical Inheritance**, karena terdapat satu superclass (Orang) yang diturunkan ke beberapa subclass
- Class Ayah, Ibu, dan Anak -> Semua class ini mewarisi atribut dari class Orang dan setiap class juga memiliki atribut tambahan sesuai perannya

## Composite Class
- Class Keluarga -> memiliki objek Ayah, Ibu, dan Anak
- Hubungan ini merupakan composition karena Keluarga memilik Ayah, Ibu, dan Anak yang menjadi bagian yang utuh dari keluarga
...
5. Program memanggil method print() pada Keluarga untuk menampilkan seluruh data keluarga
